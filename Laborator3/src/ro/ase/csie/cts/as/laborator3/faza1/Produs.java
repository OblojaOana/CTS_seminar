...
public class Produs {
	...
	public static final float DISCOUNT_CLIENT_MAXUM= 0.15f;
	...
	public float getPretFinal(TipProdus tipProdus, float pretInitial, int vechimeClientInAni)
	  {
	    float pretFinal = 0;
	    float discountFidelitate = (vechimeClientInAni > VECHIME_CLIENT_MAXIMA) ? DISCOUNT_CLIENT_MAXUM : (float)vechimeClientInAni/100; 
