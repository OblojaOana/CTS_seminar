...
public class TestProdus {
	...
	public static void main(String[] args) {
		...
		try {
		float pretFinal=produs.getPretFinal(ro.ase.csie.cts.as.laborator3.faza1.TipProdus.DISCOUNT,100,12);
	...
	pretFinal=produs.getPretFinal(ro.ase.csie.cts.as.laborator3.faza1.TipProdus.DISCOUNT, 100, 12);
	System.out.println("Pretul final este " + pretFinal);
		}
