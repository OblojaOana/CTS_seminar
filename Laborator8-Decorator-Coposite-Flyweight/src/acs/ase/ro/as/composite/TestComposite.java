package acs.ase.ro.as.composite;

public class TestComposite {

	public static void main(String[] args)
	{
		UnitateAbstractaJoc grup1 = new GrupCaractereComposite();
		UnitateAbstractaJoc grup2 = new GrupCaractereComposite();
		...
		UnitateAbstractaJoc grupNivel = new GrupCaractereComposite();
